    ...
    return(
        <li className='relative col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-2xl dark:bg-dark dark:border-light'>
            ...
            <Link className='w-full inline-block cursor-pointer overflow-hidden rounded-lg' href={link} target="_blank">
                <FramerImage sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" priority={true} src={img} alt={title} className='w-full h-auto' whileHover={{scale:1.05}} transition={{duartion:0.2}}/>
            </Link>
            <Link href={link} target='_blank'>
